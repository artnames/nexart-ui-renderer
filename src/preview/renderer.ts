...
import type { NexArtSystem, DeclarativeSystem, UnifiedSystem, PreviewOptions } from '../types';
import { isCodeModeSystem, isDeclarativeSystem, isUnifiedModeSystem } from '../system';
import { renderCodeModeSystem, CodeRenderer } from './code-renderer';
...
export function previewSystem(
  ...
  const declarativeSystem = system as DeclarativeSystem;
